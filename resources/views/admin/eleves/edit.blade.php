            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('admin/eleves/'.$eleve->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                            <div class="form-group">
                                                ...
                                                <select name="relative_id" id="" class="form-control">
                                                    ...
                                                    @foreach(App\Models\Relative::all() as $relative)
                                                        <option value="{{ $relative->id }}" @if($eleve->eleve->relative_id == $relative->id) selected @endif>{{ $relative->user->nom }} {{ $relative->user->prenom }}</option>
                                                    @endforeach
                                                </select>
                                                @error('relative_id')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="prenom" value="{{ $eleve->prenom }}" id="prenom" placeholder="Saisir prenom d'élève">
                                                @error('prenom')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="numtel" value="{{ $eleve->numtel }}" id="numtel" placeholder="Saisir numéro de téléphone d'élève">
                                                @error('numtel')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="email" value="{{ $eleve->email }}" id="email" placeholder="Saisir email d'élève">
                                                @error('email')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="date_naissance" value="{{ $eleve->date_naissance }}" id="date_naissance" placeholder="Saisir date naissance d'élève">
