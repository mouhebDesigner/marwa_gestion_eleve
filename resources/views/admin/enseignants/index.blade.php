                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-around">
                                                                    <form action="{{ url('admin/enseignants/'.$enseignant->user->id) }}" method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                    ...
                                                                    <a href="{{ url('admin/enseignants/'.$enseignant->user->id.'/edit') }}" onclick="return confirm('Voules-vous modifier cet enseignant')">
